  ...
  return (
    <div className="container text-center lh-lg">
      ...
      <div className="row">
        ...
        <p className="fs-3 p-5">A little bit about us:</p>

        <div className="image-container">
          <p className="col-5 mx-1">
            <img src={zalman} alt="Zalman" className="image-style mb-1" />
            <p className="fs-2 text-center">Zalman Azimov</p>A man of many hats,
            I am a single father to a wonderful son, an avid explorer, a
            problem-solver, and an aspiring full-stack developer with a passion
            for good music, math, science, cooking, and a love for coding.
            <p>
              {" "}
